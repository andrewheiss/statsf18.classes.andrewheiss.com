...
We will use [DataCamp](https://www.datacamp.com/home)—a collection of interactive videos and tutorials available online—to supplement your readings. These tutorials will give you additional practice with R and will be essential to understanding the material (especially in the first half of the course). 

I will assign specific excerpts from DataCamp courses as part of your readings, but by being in this class, you have access to the entire DataCamp course library for the next six months. If you ever feel bored, adventurous, or both, check out other courses and learn even more! Importantly, you do not have to purchase any services or classes from DataCamp.
